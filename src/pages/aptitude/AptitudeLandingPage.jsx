...
import { Calculator, Brain, BookOpen, Users, Lightbulb, Activity, ChevronRight } from 'lucide-react';
      ...
      <main className="flex-grow pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <p className="text-slate-400 text-sm sm:text-base mt-4 max-w-2xl">
            Master the most critical aptitude skills tested by top product-based and service-based companies. Choose a category below to begin your practice.
          </p>
        </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full py-3 px-4 bg-gradient-to-r from-[#2F80FF] to-[#1D5BD8] hover:from-[#3B8BFF] hover:to-[#2868E6] text-white font-semibold rounded-xl text-sm transition-all flex items-center justify-center gap-2 group/btn"
                  >
